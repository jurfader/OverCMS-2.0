...
// Allow plugin and theme installation/updates from the admin (needed for OverCMS marketplace bridge)
...
Config::define('EMPTY_TRASH_DAYS', 14);

// Disable XML-RPC at config level (Hardening.php also filters it)
